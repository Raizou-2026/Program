...
#ifndef INC_STM32F303_CAN_H_
#define INC_STM32F303_CAN_H_
...
class bxCAN
{
	public:
		...
		/*init function*/
		bxCAN(CAN_TypeDef* hcan);
		bxCAN(CAN_TypeDef* hcan, GPIOPin_t rx, GPIOPin_t tx);
